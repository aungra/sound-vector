...
test("unverified adaptive records cannot change another track's Top1", () => {
  ...
  const record = (targetName, provenance, recordSignature = signature, support = 5) => ({
