...
const ZIP_PATH = path.join(RWC_DIR, "RWC-P.zip");
const PART_DIR = path.join(RWC_DIR, "RWC-P.zip.parts");
const URL = "https://zenodo.org/api/records/18656623/files/RWC-P.zip/content";
const TOTAL_BYTES = 4071840278;
const EXPECTED_MD5 = "960a11a2d7fb603ad0dae8428f53d4f0";
...
console.log(`RWC-P.zip ranged download`);
...
const failures = await runPool(pending, downloadChunk);
