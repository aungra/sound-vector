...
`pcm_reversible_data` is a locked visible protected texture field inside the main artwork. It is part of the artwork, but it is not an editable decoration layer.
